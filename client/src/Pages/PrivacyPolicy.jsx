  ...
  return (
    <div className='bg-gray-900 text-white min-h-screen'>
      ...
      <div className='container mx-auto px-4 py-8'>
        ...
        <p className='mb-4'>
          Welcome to ElectiveEase. We are committed to protecting your privacy and ensuring that your personal information is handled in a safe and responsible manner. This Privacy Policy outlines how we collect, use, disclose, and protect your information.
        </p><br/>
        ...
        <div className='mb-4'>
          ...
          <p className='ml-6'>
            - Register or create an account on ElectiveEase.
          </p>
          <p className='ml-6'>
        ...
        <div className='mb-4'>
          ...
          <p className='ml-6'>
            - Usage data, including the date and time of your visits to ElectiveEase and your activities on the site.
          </p>
        </div><br/>
        ...
        <div className='mb-4'>
          ...
          <p className='ml-6'>
            - Improve and personalize your experience on ElectiveEase.
          </p>
          <p className='ml-6'>
        ...
        <p>
          If you have any questions or concerns about this Privacy Policy or our data practices, please contact us at<a href="mailto:ElectiveEase@supprt.com" className='text-blue-300'> ElectiveEase@support.com</a>
        </p>
      </div>
      </div>
    </div>
