...
<section class="bg-white dark:bg-gray-900 bg-gradient-to-b dark:from-gray-900 dark:to-gray-700">
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">About ElectiveEase</h2>
          <p class="text-gray-500 sm:text-xl dark:text-gray-400 text-justify">ElectiveEase is an Education Management System designed to simplify and enhance the management of student information and elective subject selection in educational institutions. It offers a suite of applications for students, teachers, and administrators, providing a user-friendly platform.</p>
      </div>
    ...
    <svg class="w-5 h-5 text-white lg:w-6 lg:h-6 dark:text-primary-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" d="M3 3a1 1 0 000 2v8a2 2 0 002 2h2.586l-1.293 1.293a1 1 0 101.414 1.414L10 15.414l2.293 2.293a1 1 0 001.414-1.414L12.414 15H15a2 2 0 002-2V5a1 1 0 100-2H3zm11.707 4.707a1 1 0 00-1.414-1.414L10 9.586 8.707 8.293a1 1 0 00-1.414 0l-2 2a1 1 0 101.414 1.414L8 10.414l1.293 1.293a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
              ...
              <p class="text-gray-500 dark:text-gray-400 text-justify">Our mission at ElectiveEase is to revolutionize the way educational institutions manage student information and elective subject selection. We aim to create a user-friendly platform that empowers students and administrators to navigate the complexities of education management with ease and efficiency.  </p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-500 lg:h-12 lg:w-12 dark:bg-blue-900 hover:shadow-lg transition duration-300 hover:bg-blue-600 dark:hover:bg-blue-800 hover:scale-110">
              ...
              <p class="text-gray-500 dark:text-gray-400 text-justify">ElectiveEase is committed to maintaining the highest standards of legal compliance and data protection. We adhere to all relevant educational regulations and privacy laws, ensuring that our platform safeguards the confidentiality and integrity of student information.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-500 lg:h-12 lg:w-12 dark:bg-blue-900 hover:shadow-lg transition duration-300 hover:bg-blue-600 dark:hover:bg-blue-800 hover:scale-110">
          ...
          <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-500 lg:h-12 lg:w-12 dark:bg-blue-900 hover:shadow-lg transition duration-300 hover:bg-blue-600 dark:hover:bg-blue-800 hover:scale-110">
              ...
              <p class="text-gray-500 dark:text-gray-400 text-justify">ElectiveEase offers enterprise solutions tailored to meet the needs of large educational institutions. Our enterprise package includes advanced features such as customizable dashboards and integration with existing school management systems.</p>
          </div>
          <div>
          <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-500 lg:h-12 lg:w-12 dark:bg-blue-900 hover:shadow-lg transition duration-300 hover:bg-blue-600 dark:hover:bg-blue-800 hover:scale-110">
              ...
              <p class="text-gray-500 dark:text-gray-400 text-justify">ElectiveEase is funded through a combination of venture capital, strategic partnerships, and subscription-based services. Our financial model is designed to ensure sustainability and continuous improvement of our platform.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-500 lg:h-12 lg:w-12 dark:bg-blue-900 hover:shadow-lg transition duration-300 hover:bg-blue-600 dark:hover:bg-blue-800 hover:scale-110">
              ...
              <p class="text-gray-500 dark:text-gray-400 text-justify">At ElectiveEase, we are always looking for passionate individuals to join our team. Whether you are a developer, educator, or marketing expert, we offer exciting opportunities to contribute to the future of education management. </p>
          </div>
      </div>
  </div>
</section>
